  ...
  return (
    <>
      ...
      <div className="relative w-full max-w-[600px] max-lg:hidden">
        <div onClickCapture={() => setIsOpen(prev => !prev)} className="background-light800_darkgradient text-dark200_light800 relative flex min-h-[56px] grow items-center gap-1 rounded-xl px-4 ">
