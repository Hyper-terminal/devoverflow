        ...
        <div className="relative w-full max-w-[600px] max-lg:hidden">
            <div
                ...
                <Input
                    ...
                    value=""
                    className={cn(`paragraph-regular no-focus placeholder background-light800_darkgradient focus-visible:ring-0 focus-visible:outline-none border-none shadow-none outline-none ring-0 `)}
                />
            </div>
        </div>
    );
